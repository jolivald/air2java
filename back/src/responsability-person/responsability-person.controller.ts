...
export class ResponsabilityPersonController {
  constructor(
    private readonly responsabilityPersonService: ResponsabilityPersonService,
  ) {}

  @Post()
  create(@Body() createResponsabilityPersonDto: CreateResponsabilityPersonDto) {
    return this.responsabilityPersonService.create(
      createResponsabilityPersonDto,
    );
  }
  ...
  update(
    @Param('id') id: string,
    @Body() updateResponsabilityPersonDto: UpdateResponsabilityPersonDto,
  ) {
    return this.responsabilityPersonService.update(
      +id,
      updateResponsabilityPersonDto,
    );
  }
